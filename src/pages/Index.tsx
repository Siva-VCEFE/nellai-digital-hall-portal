...
const Index = () => {
  ...
  // Hall images first (starting with blank hall), then event images
  const heroImages = [
    {
      url: "/lovable-uploads/8a2c5b5c-96f1-418c-b41e-39daaec837e2.png",
      title: "Premium Empty Conference Hall"
    },
    {
        ...
        <div className="container">
          ...
          <div className="service-category">
            ...
            <div className="services-grid">
              <div className="service-card">
                <div className="service-icon">
                  <img src="/lovable-uploads/1e6b4475-9175-4b47-9902-e7f365f3f870.png" alt="HD Projectors and Audio Visual Equipment" />
                </div>
              ...
              <div className="service-card">
                <div className="service-icon">
                  <img src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80" alt="Professional Audio Visual Equipment" />
                </div>
          ...
          <div className="service-category">
            ...
            <div className="services-grid">
              <div className="service-card">
                <div className="service-icon">
                  <img src="https://images.unsplash.com/photo-1556761175-4b46a572b786?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80" alt="Professional Event Management Services" />
                </div>
              ...
              <div className="service-card">
                <div className="service-icon">
                  <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80" alt="Premium Conference Furniture and Seating" />
                </div>
              ...
              <div className="service-card">
                <div className="service-icon">
                  <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80" alt="Professional Catering and Refreshment Services" />
                </div>
